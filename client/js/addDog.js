class Dog {
  constructor(image, name, breed, sex, size, description, features, kennelClub, pedigree, avaliable, email, owner) {
    this.image = image;
    this.name = name;
    this.breed = breed;
    this.sex = sex;
...
function createDogobject() {
  ...
  const newDog = new Dog(el.proPic.value, el.name.value, el.breed.value, el.sex.value, el.size.value, el.description.value, features, getKennelClub, getPedigree, getAvaliable, el.email.value, owner);
